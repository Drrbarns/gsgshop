        ...
        <div className="bg-white rounded-t-3xl shadow-[0_-8px_40px_rgba(0,0,0,0.15)] overflow-hidden max-w-lg mx-auto">
          ...
          <div className="px-6 pb-8">
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-lg flex-shrink-0 bg-purple-50 flex items-center justify-center">
                <img
                  src="/logo.png"
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-gray-900 text-lg truncate">GSG Shop</h3>
                <p className="text-sm text-gray-500">gsgbrands.com.gh</p>
              ...
              {[
                ...
                >
                  <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-2">
                    <i className={`${feature.icon} text-gsg-purple text-lg`} />
                  </div>
            ...
            <button
              ...
              className="w-full bg-gsg-purple hover:bg-gsg-purple-dark text-white py-4 px-6 rounded-2xl font-semibold text-base transition-all active:scale-[0.98] shadow-lg shadow-purple-700/20 flex items-center justify-center gap-2"
            >
