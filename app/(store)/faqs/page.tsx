...
export default function FAQsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'You can modify or cancel your order within 1 hour of placing it. Contact our customer service immediately via WhatsApp at +233 20 959 7443 or email support@gsgbrands.com.gh. Once an order is processed, modifications may not be possible.'
    },
    {
      category: 'orders',
